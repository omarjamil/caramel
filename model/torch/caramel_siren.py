...
def checkpoint_save(epoch: int, nn_model: siren, nn_optimizer: torch.optim, training_loss: list, validation_loss: list, model_name: str, locations: dict, args):
    """
...
def set_model(args):
    ...
    mlp = siren.Siren(args.in_features, args.hidden_size, args.nb_hidden_layers, args.nb_classes, outermost_linear=True)
