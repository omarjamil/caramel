...
def set_args():
    ...
    args.model_name = "tdiff_ae_stoch_normed_{0}_lyr_{1}_in_{2}_out_{3}_hdn_{4}_epch_{5}_btch_{6}_{7}_{8}_z{9}_stkd.tar".format(str(args.nb_hidden_layers).zfill(3),
