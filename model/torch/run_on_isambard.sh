...
rsync -avz -e "ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null" --progress caramel.py model.py data_io.py normalize.py mo-ojamil@login.isambard:/home/mo-ojamil/ML/CRM/code/torch
...
# Copy data
rsync -avz -e "ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null" --progress /project/spice/radiation/ML/CRM/data/models/datain/*_std.hdf5 mo-ojamil@login.isambard:/home/mo-ojamil/ML/CRM/data
