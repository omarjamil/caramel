...
rsync -avz -e "ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null" --progress caramel_diff_vae.py train_diff_vae.py mo-ojamil@login.isambard:/home/mo-ojamil/ML/CRM/code/torch
...
rsync -avz -e "ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null" --progress /project/spice/radiation/ML/CRM/data/models/datain/train_data_023001AQS_Qv.hdf5 mo-ojamil@login.isambard:/home/mo-ojamil/ML/CRM/data
...
rsync -avz -e "ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null" --progress /project/spice/radiation/ML/CRM/data/models/datain/test_data_023001AQS_Qv.hdf5 mo-ojamil@login.isambard:/home/mo-ojamil/ML/CRM/data
