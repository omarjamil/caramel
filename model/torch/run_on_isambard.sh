...
rsync -avz -e "ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null" --progress q.py model.py data_io.py normalize.py mo-ojamil@login.isambard:/home/mo-ojamil/ML/CRM/code/torch
