...
def plot_scm_mae(np_file):
    ...
    mean_10 = np.mean(q_[:10,:],axis=0)
    mean_100 = np.mean(q_[:100,:],axis=0)
    mean_100_200 = np.mean(q_[100:200,:],axis=0)
    mean_200_300 = np.mean(q_[200:300,:],axis=0)

    mae_10 = sklearn.metrics.mean_absolute_error(q_[:10,:],q_ml[:10,:],multioutput='raw_values')
    ...
    ax.plot(mae_100,label='mae100')
    ax.plot(mae_100_200,label='mae100_200')
    ax.plot(mae_200_300,label='mae200_300')
    # ax.plot(mae_10,label='mean10')
    ax.plot(mean_100,label='mean100')
    ax.plot(mean_100_200,label='mean100_200')
    ax.plot(mean_200_300,label='mean200_300')
    ax.legend()
    plt.show()
