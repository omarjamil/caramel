...
def nn_dataset(region:str, in_prefix="031525", suite_id="u-br800", truncate: bool=True):
    """
...
if __name__ == "__main__":
    # combine_multi_level_files(in_prefix="030405", suite_id="u-br800", new_region="9999LEAU")
    # combine_surface_level_files(in_prefix="030405", suite_id="u-br800", new_region="9999LEAU")
    # combine_subdomains("9999NEWS")
    # combine_subdomains("9999LEAU", in_prefix="030405", suite_id="u-br800")
    # nn_dataset("9999NEWS")
    # nn_dataset("9999NEWS", in_prefix="031525", suite_id="u-bj775_")
    nn_dataset("9999LEAU", in_prefix="030405", suite_id="u-br800", truncate=False)