...
do
   echo "Extracting for $r"
   mkdir -p /project/spice/radiation/ML/CRM/data/u-br800/$r
   # moo get moose:/devfc/u-bj775/field.pp/*${r}_km1p5_ra1m*.pp /project/spice/radiation/ML/CRM/data/u-bj775_/$r
   moo get moose:/devfc/u-br800/field.pp/20170106*${r}_km1p5_ra1m*.pp /project/spice/radiation/ML/CRM/data/u-br800/$r
   moo get moose:/devfc/u-br800/field.pp/20170107*${r}_km1p5_ra1m*.pp /project/spice/radiation/ML/CRM/data/u-br800/$r
   moo get moose:/devfc/u-br800/field.pp/20170108*${r}_km1p5_ra1m*.pp /project/spice/radiation/ML/CRM/data/u-br800/$r
