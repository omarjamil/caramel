...
# regions=('29N65W' '30N130W' '30N145E' '30N150W' '30N170E' '30N170W' '30N25W' '30N45W' '30S100W' '30S10E' '30S130W' '30S15W' '30S160W' '30S40W' '30S60E' '30S88E' '40N140W' '40N150E' '40N160W' '40N170E' '40N25W' '40N45W' '40N65W' '40S0E' '40S100E' '40S100W' '40S130W' '40S160W' '40S50E' '40S50W' '50N140W' '50N149E' '50N160W' '50N170E' '50N25W' '50N45W' '50S150E' '50S150W' '50S30E' '50S30W' '50S88E' '50S90W' '60N15W' '60N35W' '60S0E' '60S140E' '60S140W' '60S70E' '60S70W' '70N0E' '70S160W' '70S40W' '80N150W')
# Tropics only
...
do
    ...
    if (( gap > 45 ))
    then
        for d in {16..30} # {16..30} # {01..15}  3 4 5 9 14 18 23 30
        do
            echo region $region day $d
            # echo process_ml_lams_spice.sbatch $d $month $region --single $roseid
            echo process_ml_lams_spice.sbatch $d $month $region --multi $roseid
            # echo process_ml_lams_spice.sbatch $d $month $region --advect
            # sbatch process_ml_lams_spice.sbatch $d $month $region --single $roseid
            sbatch process_ml_lams_spice.sbatch $d $month $region --multi $roseid
