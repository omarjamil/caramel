...
def command(region, start_date, end_date):
    ...
    command_str=['sbatch --mem=10000 --ntasks=2 --time=3000 --qos=long','/home/h06/ojamil/analysis_tools/ML/CRM/caramel/data_preprocess_oj/retrieve_adv/retrieve_and_process_ml_lams_advect_tendency.py']
...
def main():
    ...
    for region in regions:
        for d in dates:
            ...
            fname='/scratch/ojamil/adv/'+region+'_'+start_date_str+"_retrieve.sh"
            # print(fname)
            with open(fname,'w') as outfile:
                outfile.write("#!/bin/bash -l\n")
                outfile.write("export PYTHONPATH=$PYTHONPATH:/net/home/h06/ojamil/analysis_tools/ML/CRM/caramel/data_preprocess_oj/retrieve_adv\n")
